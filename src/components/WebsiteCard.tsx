...
// Website portfolio card: browser-chrome frame + screenshot, signature copper
// cursor-spotlight, hover preview (scale), and a quiet "view live" link.
// The bounding rect is cached on pointer enter so the pointermove handler
// never reads layout (avoids forced reflow).
export function WebsiteCard({ project }: { project: Project }) {
